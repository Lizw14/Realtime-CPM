...
import sys
caffe_path = '/home/lizhuowan/Realtime_Multi-Person_Pose_Estimation/caffe_rtpose/python/'
...
f.savefig(savedir+'2.png')
f2.savefig(savedir+'3.png')
f3.savefig(savedir+'4.png')
